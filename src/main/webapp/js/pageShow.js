...
$('add').onclick = function (e) {
    ...
    var productDetail = {'id': id, 'price': price, 'title': title, 'num': num};  //这是一个object类型
    var name = 'products';
    var productList1 = new Array;
    var productList = util.getCookie(name);  //从cookie中取出名为name对应的value
    ...
    if (productList == "" || productList == null) {
        productList1.push(productDetail); //push方法就是添加新元素到数组的末尾
